...
/*** RICERCA PER AMMINISTRAZIONE CENTRALE ***/
public class DataGetterForAmministrazioneCentrale {
	public List<Amministrazione> searchForAmministrazioneCentrale(String amministrazione_input) {
		...
		String queryString = "prefix rdfs: <http://w3.org/2000/01/rdf-schema#> "+
								...
								"	?cod_cat digitPA:tipologia_amministrazione \"C\" . "+
